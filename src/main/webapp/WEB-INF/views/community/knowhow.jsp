			...
			<div class="row">
				<div class="col-12 mb-2">
					<div class="d-flex justify-content-between">
						...
						<a class="btn btn-light btn-sm text-info border border-info rounded-pill pt-2" href="${pageContext.request.contextPath}/profile/knowhowwrite.do">
				...
				<div class="col-12">
					<div class="pl-2">
						<button type="button" class="btn btn-light active mb-2 mr-1 font-weight-bold" id="selectBtn" onClick="selectBtn('all')">전체</button>
						<button type="button" class="btn btn-light active mb-2 mr-1 font-weight-bold" id="selectBtn" onClick="selectBtn('1')">패션코디팁</button>
						<button type="button" class="btn btn-light active mb-2 mr-1 font-weight-bold" id="selectBtn" onClick="selectBtn('2')">의류지식</button>
						<button type="button" class="btn btn-light active mb-2 mr-1 font-weight-bold" id="selectBtn" onClick="selectBtn('3')">나의리폼</button>
						<button type="button" class="btn btn-light active mb-2 mr-1 font-weight-bold" id="selectBtn" onClick="selectBtn('4')">원단과부자재</button>
						<button type="button" class="btn btn-light active mb-2 mr-1 font-weight-bold" id="selectBtn" onClick="selectBtn('5')">패션뉴스</button>
						<button type="button" class="btn btn-light active mb-2 mr-1 font-weight-bold" id="selectBtn" onClick="selectBtn('6')">생활필수</button>
					</div>
				</div>
			</div>
