				...
				.ajax({
					...
					success : function(resultList) {
						...
						for (var i = 0; i < resultList.length; i++) {
							...
							html += '<img src="${pageContext.request.contextPath}/resources/img/'+result.MD_PROIMG+'" alt="사진" class="profile mr-3 mt-3 rounded-circle border img-fluid" style="width:50px; height: 50px;" />';
							html += '</a>';
							html += '</div>';
							...
							if (result.MD_DEPT == '1') {
								html += '패턴디자이너';
							} else if (result.MD_DEPT == '2') {
								html += '텍스타일디자이너';
							} else if (result.MD_DEPT == '3') {
								html += '의상디자이너';
							} else if (result.MD_DEPT == '4') {
								html += '패션MD';
							}
							html += '</small>';
							html += '</div>';
...
<body>
	...
	<section class="optionList_section">
		<div class="container mt-3">
			<div class="d-flex">
				...
				<div class=" mr-1">
					<select class="custom-select custom-select-sm border border-secondary mb-3" id="select2">
						<option value="0" selected>패션분야</option>
				...
				<!-- 				
				<div class=" mr-1">
					<select class="custom-select custom-select-md border border-secondary mb-3">
				...
				<div class=" mr-1">
					<select class="custom-select custom-select-sm border border-secondary mb-3" id="select3">
						<option value="0" selected>경력</option>
						<option value="1">5년미만</option>
						<option value="2">5년-10년</option>
						<option value="3">10-15년</option>
						<option value="4">15-20년</option>
			...
			<!-- //이미지게시물 -->
			<%-- <div class="row">
				<div class="col-sm-12 col-md-4 col-xl-3 px-2">
					<div class="media mb-3">
						<div>
							<a href="">
								<img src="${pageContext.request.contextPath}/resources/images/profile_pic/w4.jpg" alt="w4" class="profile mr-3 mt-3 rounded-circle" width="60px" />
							</a>
						</div>
						<div class="media-body pt-4">
							<div class="card-text">정인선</div>
							<small class="card-text">패턴디자이너</small>
						</div>
					</div>
					<a href="${pageContext.request.contextPath}/profile/pphotoview.do">
						<img class="img-fluid rounded" src="${pageContext.request.contextPath}/resources/images/profile_bg/md01.jpg" alt="c1" />
					</a>
					<p class="sl-title d-flex justify-content-around">
						...
						<a href="#" class="card-link">
							<i class="far fa-comment-alt"></i> 14
						</a>
					</p>
					<div class="text-break pb-5">
						<span>제가 25평 아파트를 거짓말 조금보태 100군데 정도 견적서를 받아보았고, 을지로에 업체들을</span>
					</div>
				</div>
