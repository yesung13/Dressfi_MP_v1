    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="mt-3">
                    <img class="img-fluid" style="width: 1500px; height: 500px;"
                         src="${pageContext.request.contextPath}/resources/images/profile_bg/intro.jpg" alt="intro"/>
                </div>

                <h5 class="text-justify text-break mt-2">
                    <strong>DressFi</strong>는 <b>의류업계 전문가</b> 또는 <b>의류업계 입문자</b>들의 커뮤니티 사이트입니다. <br>자신을 홍보할 수 있는 작품 또는
                    관련 사진을 프로필에 업로드 하여 자신을 어필 할 수 있으며, 제안서기능을 통해 원하는 분야의 크루들을 찾아 프로젝트를 계획할 수도 있습니다.
                </h5>
                <br>
                <dl class="row mb-2">
                    <dt class="col-sm-12">
                    ...
                    <dd class="col-sm-12 ml-2">
                        <i class="far fa-lightbulb"></i>&nbsp;디자인 샘플, 디자인한 상품을 상품화 및 납품하기 위해 공장 및 도매&middot;소매 상점이 필요하신
                        디자이너분들
                    </dd>
                    <dd class="col-sm-12 ml-2">
                ...
                <dl class="row mb-5">
                    ...
                    <dd class="col-sm-12 ml-2">
                        <i class="far fa-lightbulb"></i>&nbsp;의류업계 필수 분야로 옷을 디자인하는 <b>디자이너</b>, 옷을 생산하는<b>공장</b>, 옷을
                        판매하는 <b>도소매</b> 상점 이렇게 총 3개의 분야로 구분했습니다.
                    </dd>
                    <dd class="col-sm-12 ml-2 mb-5">
                        <i class="far fa-lightbulb"></i>&nbsp;의류업계 전문가분들은 <b>전문가 회원</b>으로 등록하실 수 있으며, 자신을 어필할 게시물을 등록하여
                        홍보할 수 있습니다.
                    </dd>
