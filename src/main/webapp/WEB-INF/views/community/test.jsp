			...
			<div class="row mt-4">
					...
					<div class="mt-1  photo-view-fill  mb-5">
						<div class="col-xl-12">
							<div class="card profile-card-2">
								...
								<div class="">
									<a href="#">
										<img class="img-fluid rounded border" src="${portfolio.i_fileloc }" alt="사진" style="width: 1000px; height: 700px" />
									</a>
								</div>
				...
				<div class="col-sm-12 col-md-12 col-xl-4 photo-fill-2 mt-1">
					...
					<div class="d-flex flex-row justify-content-between margin-30">
						<div class="">
							<a href="${pageContext.request.contextPath}/profile/userhome.do?i_mnum=${mnum}&i_mdiv=${mmno}">
								<img src="<c:url value="/resources/img/${proimg}/"/>" alt="프로필사진" width="50" height="50" class="img-fluid rounded-circle ml-1">
					...
					<c:forEach items="${portfolioList}" var="item">
						<c:if test="${portfolio.ino != item.ino }">
							<div class="col-sm-6 col-md-6 col-lg-6 ">
								<div class="card profile-card-2">
									<div class="">
										<a href="${pageContext.request.contextPath}/profile/userpphotoview.do?ino=${item.ino}&i_mnum=${mnum}&i_mdiv=${mmno}">
											<img class="img-fluid rounded border" src="${item.i_fileloc }" alt="${i_fileloc }" style="width: 350px; height: 150px" />
										</a>
									</div>
								</div>
							</div>
			...
			<div class="row ml-3 mt-4">
				...
				<form class="col-12 mb-3">
					<div class="orm-group ml-auto d-flex justify-content-start">
						...
						<div class="w-75">
							<input type="text" class="form-control" id="exampleInputEmail1" placeholder="칭찬과 격려의 글은 작성자에게 큰힘이 됩니다.">
						</div>
					</div>
				</form>
				<!--//내 댓글  -->
				...
				<div class="col-12 mb-3">
					<div>
						<img src="${pageContext.request.contextPath}/resources/images/profile_pic/w5.jpg" alt="사진" width="30" height="30" class="profile rounded-circle" />
