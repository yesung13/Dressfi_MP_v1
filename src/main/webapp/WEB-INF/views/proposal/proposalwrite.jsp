			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-xl-12">
					<ul class="nav nav-pills pople">
						<li class="nav-item">
							<a class="text-sm-center nav-link" href="${pageContext.request.contextPath}/proposal/proposalrec.do">받은 제안서</a>
						</li>
						<li class="nav-item">
							<a class="text-sm-center nav-link" href="${pageContext.request.contextPath}/proposal/proposalsend.do">보낸 제안서</a>
						</li>
						<li class="nav-item">
							<a class="text-sm-center nav-link active" href="${pageContext.request.contextPath}/proposal/proposalwrite.do">제안서 작성</a>
						</li>
					</ul>
				</div>
				<div class="my-4 py-5">
					...
					<form action="/dressfi/proposal/proposalwrite.do" method="post" enctype="multipart/form-data">
						...
						<div class="form-row">
							<div class="form-group col-xl-6 col-md-6 col-sm-12">
								...
								<input name="pr_startdate" type="text" class="form-control" style="height: 40px;" id="sender" placeholder="20190101">
							</div>
							<div class="form-group col-xl-6 col-md-6 col-sm-12">
								<label for="sender">작업종료일</label>
								<input type="text" name="pr_enddate" class="form-control" style="height: 40px;" id="sender" placeholder="20191231">
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-xl-12 col-md-12 col-sm-12">
								<textarea class="form-control" rows="9" aria-label="With textarea" name="pr_context"></textarea>
							</div>
						</div>
						...
						<div class="form-row d-flex justify-content-end">
							<div class="col-xl-6 col-md-12 col-sm-12">
								<button type="submit" class="col-xl-6 col-md-6 col-sm-6 btn btn-dark active w-50">보내기</button>
								<button type="reset" class="col-xl-6 col-md-6 col-sm-6 btn btn-light active w-50 ">취소</button>
							</div>
						</div>
					</form>
				</div>
