            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-4 border-bottom">
                        <div class="col-sm-12">
                            <label for="receive"
                                   class="col-sm-12 col-md-2 col-xl-2 col-form-label text-info">보낸사람</label>
                            <div class="col-sm-12 col-md-4 col-xl-4">
                                <input type="text" readonly
                                       class="form-control-plaintext text-center" id="receive"
                                       value="${psal.pr_sendid }">
                            </div>
                            <label for="send"
                                   class="col-sm-12 col-md-2 col-xl-2 col-form-label">받는사람</label>
                            <div class="col-sm-12 col-md-4 col-xl-4">
                                <input type="text" readonly
                                       class="form-control-plaintext text-center" id="send"
                                       value="${psal.pr_targetid }">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-start mb-1">
                        <div class="col-sm-12">
                            <label class="col-12 col-md-2 col-xl-2 col-form-label bg-light">선호지역</label>
                            <div class="col-12 col-md-4 col-xl-4 mt-1">
                                <span class="font-weight-bold ">${pr_area }</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-start mb-1">
                        <div class="col-sm-12">
                            <label class="col-12 col-md-2 col-xl-2 col-form-label bg-light">작업기간</label>
                            <div class="col-12 col-md-4 col-xl-4 mt-1">
                                <span class="font-weight-bold">${psal.pr_startdate }</span><span
                                    class="font-weight-bold mx-2">-</span><span
                                    class="font-weight-bold">${psal.pr_enddate }</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-start">
                        <label for="fileloc"
                               class="col-sm-12 col-md-2 col-xl-2  col-form-label bg-light">첨부파일</label>
                        <div class="col-sm-12 col-md-4 col-xl-4 ">
                            <!-- 								<small class="text-muted align-bottom" id="fileloc">첨부파일 목록</small> -->
                            <c:if test="${not empty psal.pr_fileloc}">
                                <img class="img-fluid rounded border" src="${psal.pr_fileloc }"
                                     alt="사진" style="width: 1000px; height: 700px"/>
                            </c:if>
                            <c:if test="${empty psal.pr_fileloc}">
                    ...
                    <div class="form-group row ">
                        <label for="staticEmail"
                               class="col-sm-12 col-form-label  border-top border-bottom">내&nbsp;&nbsp;용</label>
                        <div class="col-sm-12 text-break text-justify mt-2">
                            <!-- <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="email@example.com"> -->
                            <p>${psal.pr_context}</p>
                        </div>
                    </div>
                </div>
                <div class="card-footer text-muted text-right">${psal.pr_regdate }</div>
                <!-- 작성날짜 -->
            </div>
