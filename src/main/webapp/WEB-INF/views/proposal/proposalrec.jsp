			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-xl-12">
					<ul class="nav nav-pills pople">
						<li class="nav-item">
							<a class="text-sm-center nav-link active" href="${pageContext.request.contextPath}/proposal/proposalrec.do">받은 제안서</a>
						</li>
						<li class="nav-item">
							<a class="text-sm-center nav-link" href="${pageContext.request.contextPath}/proposal/proposalsend.do">보낸 제안서</a>
						</li>
						<li class="nav-item">
							<a class="text-sm-center nav-link" href="${pageContext.request.contextPath}/proposal/proposalwrite.do">제안서 작성</a>
						</li>
					</ul>
				</div>
				<div class="my-4 py-5">
					<h4 class="font-weight-bolder mt-2 mb-4">받은 제안서</h4>
