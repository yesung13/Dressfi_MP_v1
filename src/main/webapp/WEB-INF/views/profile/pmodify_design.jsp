        ...
        <div class="row">
            ...
            <div class="border my-4 py-5">
                <div class="px-3 px-sm-3 px-xl-5">
                    ...
                    <form action="/dressfi/profile/dpmodify.do" method="post" enctype="multipart/form-data">
                        <table class="table table-borderless">
                            <tr>
                                <td>
                                    <input type="hidden" id="mdno" name="mdno" class="form-control"
                                           value="${loginUser.mno}"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" class="form-control disabled" placeholder="사용자 아이디 보이기"
                                           value="${userId}" name="userId" id="userId" readonly>
                                    <!-- 사용자 아이디 불러오기(수정불가능) -->
                                </td>
                                <td></td>
                                <!-- 공간맞춘것 지우지 말것 -->
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="md_phone" name="md_phone" class="form-control" maxlength="11"
                                           value="${profile.md_phone}">
                                    <!-- 사용자 휴대번호 불러오기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="md_homepage" name="md_homepage" class="form-control"
                                           placeholder="주소입력" value="${profile.md_homepage}"/>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50">
                                        <select class="custom-select" path="md_business" name="md_business"
                                                id="md_business">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="md_bnum" name="md_bnum" class="form-control" maxlength="10"
                                           value="${profile.md_bnum}"/>
                                    <!--주소링크 가능하게 하여 입력받으면 링크 걸리게 만들기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="md_bname" name="md_bname" class="form-control"
                                           placeholder="주소입력" value="${profile.md_bname}"/>
                                    <!--주소링크 가능하게 하여 입력받으면 링크 걸리게 만들기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50 mb-1">
                                        <input type="text" class="form-control col-12" id='md_bzip' path='md_bzip'
                                               name='md_bzip' size='7' maxlength='7' value="${profile.md_bzip}"/>
                                    ...
                                    <input type="text" class="form-control mb-1 w-75" maxlength='50' size='50'
                                           id='md_badd1' name='md_badd1' value="${profile.md_badd1 }" path='md_badd1'/>
                                    <input type="text" class="form-control w-75" maxlength='50' size='50' id='md_badd2'
                                           name='md_badd2' path='md_badd2' value="${profile.md_badd2 }"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="form-inline">
                                        <select class="custom-select" name="md_ano1">
                                            <option value="10">서울</option>
                                            <option value="20">강원</option>
                                            <option value="30">대천</option>
                                        </select>
                                        <select class="custom-select mx-2" name="md_ano2">
                                            <option value="10">서울</option>
                                            <option value="20">강원</option>
                                            <option value="30">대천</option>
                                        </select>
                                        <select class="custom-select" name="md_ano3">
                                            <option value="10">서울</option>
                                            <option value="20">강원</option>
                                            <option value="30">대천</option>
                                        </select>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="md_introduce" name="md_introduce" class="form-control"
                                           placeholder="입력" value="${profile.md_introduce}"/>
                                    <!-- text로 입력받기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="md_kakaourl" name="md_kakaourl" class="form-control"
                                           placeholder="입력" value="${profile.md_kakaourl}"/>
                                    <!-- text로 입력받기 -->
                                </td>
                            </tr>
                            <tr>
