...
<body style="padding-top: 70px">
	...
	<div class="container mt-5">
		<div class="jumbotron border bg-light">
			<p class="text-center">
				<i class="far fa-images fa-2x text-888" id="img" style="display: block;"><span class="lead text-center text-888 text-bold ml-2">커버 업로드</span></i> <i id="upimg" style="display: none;"><img id="blah" style="width: 100%; height: 100%" class="far fa-images fa-2x text-888" alt="..." /></i>
			</p>
		...
		<div class="container photo-margin mt-2">
			<div class="row  ml-3">
				...
				<form action="knowhowwrite_insert.do" method="post" enctype="multipart/form-data">
					...
					<div class="form-group col-12">
						<textarea class="form-control" rows="5" placeholder="글내용을 입력해 주세요." id="h_text" name="h_text"></textarea>
					</div>
