        ...
        <div class="row">
                ...
                <ul class="nav nav-pills pople justify-content-center">
                    <li class="nav-item">
                        <a class="text-sm-center nav-link active"
                           href="${pageContext.request.contextPath}/profile/pmodify.do">프로필수정</a>
                    </li>
                    <li class="nav-item">
                        <a class="text-sm-center nav-link"
                           href="${pageContext.request.contextPath}/profile/peditpasswd.do">비밀번호변경</a>
                    </li>
                </ul>
            </div>
            <div class="border my-4 py-5">
                <div class="px-3 px-sm-3 px-xl-5">
                    ...
                    <form action="/dressfi/profile/cpmodify.do" method="post" enctype="multipart/form-data">
                        <table class="table table-borderless">
                            <tr>
                                <td>
                                    <input type="hidden" id="mcno" name="mcno" class="form-control"
                                           value="${loginUser.mno}"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" class="form-control disabled" value="${userId}" name="userId"
                                           id="userId" readonly>
                                    <!-- 사용자 아이디 불러오기(수정불가능) -->
                                </td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <a href="#">
                                        <!-- 클릭 시 사진 업로드 -->
                                        <img id="blah" src="<c:url value="/resources/img/${p_img}/"/>"
                                             class="rounded img-fluid float-left" alt="..."
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" class="form-control" placeholder="사용자 성명 보이기"
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mc_phone" name="mc_phone" class="form-control" maxlength="11"
                                           value="${profile.mc_phone}">
                                    <!-- 사용자 휴대번호 불러오기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mc_homepage" name="mc_homepage" class="form-control"
                                           placeholder="주소입력" value="${profile.mc_homepage}"/>
                                    <!--주소링크 가능하게 하여 입력받으면 링크 걸리게 만들기 -->
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <span class="">구분(도매,소매)</span>
                                </th>
                                <td colspan="2">
                                    <div class="input-group w-50">
                                        <select class="custom-select" name="mc_div">
                                            <option value="W">도매</option>
                                            <option value="S">소매</option>
                                        </select>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mc_bnum" name="mc_bnum" class="form-control" maxlength="10"
                                           value="${profile.mc_bnum}"/>
                                    <!--주소링크 가능하게 하여 입력받으면 링크 걸리게 만들기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mc_bname" name="mc_bname" class="form-control"
                                           placeholder="주소입력" value="${profile.mc_bname}"/>
                                    <!--주소링크 가능하게 하여 입력받으면 링크 걸리게 만들기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50 mb-1">
                                        <input type="text" class="form-control col-12" id='mc_bzip' path='mc_bzip'
                                               name='mc_bzip' size='7' maxlength='7' value="${profile.mc_bzip}"/>
                                    ...
                                    <input type="text" class="form-control mb-1 w-75" maxlength='50' size='50'
                                           id='mc_badd1' name='mc_badd1' value="${profile.mc_badd1 }" path='mc_badd1'/>
                                    <input type="text" class="form-control w-75" maxlength='50' size='50' id='mc_badd2'
                                           name='mc_badd2' path='mc_badd2' value="${profile.mc_badd2 }"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="form-inline">
                                        <select class="custom-select" name="mc_ano1">
                                            <option value="10">서울</option>
                                            <option value="20">강원</option>
                                            <option value="30">대천</option>
                                        </select>
                                        <select class="custom-select mx-2" name="mc_ano2">
                                            <option value="10">서울</option>
                                            <option value="20">강원</option>
                                            <option value="30">대천</option>
                                        </select>
                                        <select class="custom-select" name="mc_ano3">
                                            <option value="10">서울</option>
                                            <option value="20">강원</option>
                                            <option value="30">대천</option>
                                        </select>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mc_introduce" name="mc_introduce" class="form-control"
                                           placeholder="입력" value="${profile.mc_introduce}"/>
                                    <!-- text로 입력받기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mc_kakaourl" name="mc_kakaourl" class="form-control"
                                           placeholder="입력" value="${profile.mc_kakaourl}"/>
                                    <!-- text로 입력받기 -->
                                </td>
                            </tr>
                            <tr>
