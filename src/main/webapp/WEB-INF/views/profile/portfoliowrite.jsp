						...
						<div class="row">
							<div class="form-group col-xl-6 col-sm-12 pr-1">
								<div class="jumbotron border bg-light">
									<p class="text-center">
										<i class="far fa-images fa-2x text-888" id="img" style="display: block;"> <span class="lead text-center text-888 text-bold">사진 업로드</span></i> <i id="upimg" style="display: none;"> <img id="blah" style="width: 100%; height: 100%" class="far fa-images fa-2x text-888" alt="..." /></i>
									</p>
							...
							<div class="form-group col-xl-6 col-sm-12">
								<div>
									...
									<input type="text" placeholder="제목을 입력하세요" class="form-control mb-1" id="i_title" name="i_title" style="height: 30px;">
									<textarea class="form-control" cols="40" placeholder="사진에 대해 설명하세요" id="i_text" name="i_text" style="height: 270px;"></textarea>
								</div>
