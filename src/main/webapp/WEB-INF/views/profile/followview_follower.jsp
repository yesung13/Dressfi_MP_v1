        ...
        <div class="row">
            ...
            <div class="my-4 py-5">
                <div class="px-3 px-sm-3 px-xl-5">
                    <h4 class="font-weight-bolder mt-2 mb-4">팔로워</h4>
                    <div class="col-sm-12 col-md-12 col-xl-12 ">
                        <ul class="list-group list-group-flush py-3 ">
                            <li class="list-group-item border-bottom"><img
                                    ...
                                    class="font-weight-bold">${user.name}</span></li>
                        </ul>
                    </div>
                    <c:forEach var="fl" items="${fllist}">
                        <li class="list-group-item border-bottom"><img
                                src="<c:url value="/resources/img/${fl.fwimg}/"/>" alt="사진"
                                class=" mr-1 rounded-circle border img-fluid"
                                style="width: 50px; height: 50px;"/> <span
                                class="font-weight-bold">${fl.follower}</span> <!-- 전문가회원들 마다 분야 가져오기 -->
                        </li>
                    </c:forEach>
                </div>
            </div>
