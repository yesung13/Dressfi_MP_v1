        ...
        <div class="row mt-4 ">
            <div class="col-sm-12 col-md-12 col-xl-4 mb-4 mypage-fill pofill-bor">
                ...
                <div class="d-flex justify-content-between mb-4">
                    ...
                    <!-- 글쓰기  -->
                    <a class="text-secondary text-decoration-none  sr-only"
                       href="${pageContext.request.contextPath}/profile/pwrite.do?userId=${userId}">
                        <i class="fas fa-pen"></i>
                        <span> 글쓰기</span>
                    </a>
                </div>
                <div class="d-flex justify-content-end mb-1">
                    <a class="snschat text-decoration-none text-muted" href="${profile.kakaourl}" data-toggle="tooltip"
                       data-placement="bottom" title="카카오톡 오픈채팅">
                ...
                <div class="d-flex profileimg mb-2">
                    <img src="<c:url value="/resources/img/${p_img}/"/>" alt="프로필사진" width="150"
                         class="rounded-circle"/>
                </div>
                ...
                <div class="d-flex mb-1">
                    <a class="text-decoration-none"
                       href="${pageContext.request.contextPath}/profile/followerView.do?userName=${loginUser.name}">
                        <span class="text-black-50 font-weight-bold">팔로워</span>
                        <span class="sr-only">팔로워 수 코딩자리</span>

                    </a>
                    <a class="text-decoration-none"
                       href="${pageContext.request.contextPath}/profile/followingView.do?userName=${loginUser.name}">
                ...
                <div class="d-flex justify-content-center mb-3 invisible">
                    ...
                    <button class="btn btn-secondary bg-ddd text-center text-black font-weight-bold w-100 mr-1">팔로우
                    </button>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="card profile-card-2">
                            <div class="card-img-block">
                                <a href="">
                                    <img class="img-fluid"
                                         src="${pageContext.request.contextPath}/resources/images/profile_bg/c1.jpg"
                                         alt="c1"/>
                                </a>
                            </div>
                        </div>
