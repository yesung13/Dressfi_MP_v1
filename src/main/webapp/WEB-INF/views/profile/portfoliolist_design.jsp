        ...
        <div class="row mt-4">
            <div class="col-sm-12 col-md-12 col-xl-4 mb-4 mypage-fill pofill-bor">
                ...
                <div class="d-flex profileimg mb-2">
                    <img src="<c:url value="/resources/img/${profile.md_proimg}/"/>" alt="프로필사진" width="150"
                         class="rounded-circle"/>
                </div>
                ...
                <ul class="nav nav-pills pople">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="${pageContext.request.contextPath}/profile/portfoliolist_design.do?userId=${profile.md_userId}">포트폴리오 </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                           href="${pageContext.request.contextPath}/profile/knowhow_design.do?userId=${profile.md_userId}">노하우 </a>
                    </li>
                </ul>
                <!-- 이미지게시물  -->
                <div class="container">
