                ...
                <div class="px-3 px-sm-3 px-xl-5">
                    ...
                    <form action="/dressfi/profile/fpmodify.do" method="post" enctype="multipart/form-data">
                        <table class="table table-borderless">
                            <tr>
                                <td>
                                    <input type="hidden" id="mfno" name="mfno" class="form-control"
                                           value="${loginUser.mno}"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mf_phone" name="mf_phone" class="form-control" maxlength="11"
                                           value="${profile.mf_phone}">
                                    <!-- 사용자 휴대번호 불러오기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mf_homepage" name="mf_homepage" class="form-control"
                                           placeholder="주소입력" value="${profile.mf_homepage}"/>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mf_bnum" name="mf_bnum" class="form-control" maxlength="10"
                                           value="${profile.mf_bnum}"/>
                                    <!--주소링크 가능하게 하여 입력받으면 링크 걸리게 만들기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mf_bname" name="mf_bname" class="form-control"
                                           placeholder="주소입력" value="${profile.mf_bname}"/>
                                    <!--주소링크 가능하게 하여 입력받으면 링크 걸리게 만들기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50 mb-1">
                                        <input type="text" class="form-control col-12" id='mf_bzip' path='mf_bzip'
                                               name='mf_bzip' size='7' maxlength='7' value="${profile.mf_bzip}"/>
                                    ...
                                    <input type="text" class="form-control mb-1 w-75" maxlength='50' size='50'
                                           id='mf_badd1' name='mf_badd1' value="${profile.mf_badd1 }" path='mf_badd1'/>
                                    <input type="text" class="form-control w-75" maxlength='50' size='50' id='mf_badd2'
                                           name='mf_badd2' path='mf_badd2' value="${profile.mf_badd2 }"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mf_introduce" name="mf_introduce" class="form-control"
                                           placeholder="입력" value="${profile.mf_introduce}"/>
                                    <!-- text로 입력받기 -->
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" id="mf_kakaourl" name="mf_kakaourl" class="form-control"
                                           placeholder="입력" value="${profile.mf_kakaourl}"/>
                                    <!-- text로 입력받기 -->
                                </td>
                            </tr>
                            <tr>
