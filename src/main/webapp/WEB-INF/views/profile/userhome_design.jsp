			...
			<div class="row mt-4">
				<div class="col-sm-12 col-md-12 col-xl-4 mb-4 mypage-fill pofill-bor">
					...
					<div class="d-flex mb-1">
						<a class="text-decoration-none" href="${pageContext.request.contextPath}/profile/followerView.do?userName=${profile.md_name}">
							<span class="text-black-50 font-weight-bold">팔로워</span>
							<span class="sr-only">팔로워 수 코딩자리</span>

						</a>
						<a class="text-decoration-none" href="${pageContext.request.contextPath}/profile/followingView.do?userName=${profile.md_name}">
							<span class="text-black-50 font-weight-bold ml-3">팔로잉</span>
					...
					<div class="d-flex justify-content-center mb-3">
						...
						<c:if test="${folyn eq 'y'}">
							<button class="btn btn-secondary bg-ddd text-center text-black font-weight-bold w-100 mr-1" onclick="fAction(1)">팔로우 취소</button>

						</c:if>

						<!-- 추후 본인일 경우는 안보이게하고 / 다른 회원이 프로필을 볼땐 팔로우  -->
				...
				<div class="col-sm-12 col-md-12 col-xl-8  mypage-fill">
					...
					<ul class="nav nav-pills pople">
						<li class="nav-item">
							<a class="nav-link active" href="${pageContext.request.contextPath}/profile/userhome.do?i_mdiv=${i_mdiv}&i_mnum=${i_mnum}">모두보기</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="${pageContext.request.contextPath}/profile/portfoliolist_design.do?userId=${profile.md_userId}">포트폴리오 </a>
						</li>
						<li class="nav-item">
					...
					<!--포트폴리오 게시물 -->
					<div class="container mt-1 portfolio">
						<h5>
							<strong>포트폴리오 게시물</strong>
								...
								<div class="card profile-card-2">
									<div class="card-img-block">
										<a href="${pageContext.request.contextPath}/profile/userpphotoview.do?ino=${item.ino}&i_mnum=${item.i_mnum}&i_mdiv=${item.i_mdiv}">
											<img class="img-fluid rounded border" src="${item.i_fileloc }" alt="${item.i_fileloc }" style="width: 200px; height: 150px;" />
										</a>
									</div>
								</div>
							</div>
						...
						<%-- 		<div class="swiper-container">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/profile_bg/c2.jpg" alt="c1" />
									portfolio
								</div>
								<div class="swiper-slide">
									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/profile_bg/c2.jpg" alt="c1" />
					...
					<div class="container mt-1 portfolio">
						<h5>
							<strong>노하우 게시물</strong>
							<label class="text-info">${knowhowSize }</label>
						</h5>
								...
								<div class="card profile-card-2">
									<div class="card-img-block">
										<a href="${pageContext.request.contextPath}/profile/knowhowview.do?hno=${item.hno}&userId=${userId}">
											<img class="img-fluid rounded border" src="${item.h_fileloc }" alt="${item.h_fileloc }" style="width: 200px; height: 150px;" />
										</a>
									</div>
								</div>
							</div>
