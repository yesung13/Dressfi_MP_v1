				...
				<div class="col-sm-12 col-md-12 col-xl-4 mb-4  mypage-fill pofill-bor">
					...
					<div class="d-flex justify-content-between mb-4 invisible">
						<a class="text-secondary text-decoration-none " href="${pageContext.request.contextPath}/profile/pmodify.do?userId=${userId}">
							<i class="fas fa-cog"></i><span> 프로필 수정</span>
						</a>
						<!-- 글쓰기  -->
						<a class="text-secondary text-decoration-none  sr-only" href="${pageContext.request.contextPath}/profile/pwrite.do?userId=${userId}">
					...
					<div class="d-flex profileimg mb-2">
						<img src="<c:url value="/resources/img/${p_img}/"/>" alt="프로필사진" width="150" class="rounded-circle" />
					</div>
					...
					<div class="d-flex mb-1">
						<a class="text-decoration-none" href="${pageContext.request.contextPath}/profile/followerView.do?userName=${loginUser.name}">
							<span class="text-black-50 font-weight-bold">팔로워</span>
							<span class="sr-only">팔로워 수 코딩자리</span>

						</a>
						<a class="text-decoration-none" href="${pageContext.request.contextPath}/profile/followingView.do?userName=${loginUser.name}">
					...
					<div class="d-flex justify-content-center mb-3">
						...
						<a class="snschat text-decoration-none text-muted" href="${profile.kakaourl}" data-toggle="tooltip" data-placement="bottom" title="카카오톡 오픈채팅">
							<img src="${pageContext.request.contextPath}/resources/images/svg/open-kakao.svg">
						</a>
					</div>
					<div class="mb-4">
						<strong class="text-center text-muted font-weight-bold">${profile.introduce }</strong>
					</div>
 ...
 --%>
					...
					<table class="table table-borderless table-sm">
						...
						<tr>
							...
							<td colspan="2">
								<span class="">${profile.homepage }</span>
							</td>
						</tr>
					</table>
				</div>
				...
				<div class="col-sm-12 col-md-12 col-xl-8 mypage-fill">
					...
					<ul class="nav nav-pills pople">
						<li class="nav-item">
							<a class="nav-link active" href="${pageContext.request.contextPath}/profile/myhome.do">모두보기</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="${pageContext.request.contextPath}/profile/knowhow_design.do">노하우 </a>
						</li>
						<li class="nav-item">
					...
					<div class="container mt-1 portfolio">
						<h5>
							...
							<label class="text-info">74</label>
						</h5>
						<div class="col-sm-6 col-md-4 col-lg-3">
							<div class="card profile-card-2">
								<div class="card-img-block">
									<a href="">
										<img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/profile_bg/c1.jpg" alt="c1" />
									</a>
								</div>
							</div>
						</div>
