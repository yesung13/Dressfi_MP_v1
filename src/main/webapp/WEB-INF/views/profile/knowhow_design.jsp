 ...
 --%>
				...
				<div class="col-sm-12 col-md-12 col-xl-8 mypage-fill">
					...
					<ul class="nav nav-pills pople">
						...
						<li class="nav-item">
							<a class="nav-link active" href="${pageContext.request.contextPath}/profile/knowhow_design.do?userId=${profile.md_userId}">노하우 </a>
						</li>
					</ul>
					<!-- 이미지게시물  -->
					<div class="container">
							...
							<c:forEach items="${knowhowList}" var="item">
								<div class="col-sm-12 col-md-12 col-xl-4 px-2">
									<a href="${pageContext.request.contextPath}/profile/knowhowview.do?hno=${item.hno}&userId=${userId}">
										<img class="img-fluid rounded border" src="${item.h_fileloc }" alt="${item.h_fileloc }" style="width: 400px; height: 180px;" />
									</a>
