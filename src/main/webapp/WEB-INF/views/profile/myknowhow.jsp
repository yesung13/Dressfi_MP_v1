...
<body style="padding-top: 70px">
	...
	<section>
		<div class="container">
			<div class="row mt-4">
				<div class="col-md-4 mypage-fill pofill-bor">
					<!-- 프로필정보수정  -->
					<!-- **회원만보이게**  -->
					<div class="d-flex justify-content-between mb-4">
						...
						<!-- 글쓰기  -->
						<a class="text-secondary text-decoration-none  " href="${pageContext.request.contextPath}/profile/knowhowwrite.do?userId=${userId}">
				...
				<!-- 프로필 정보 -->
				<div class="col-md-8  mypage-fill">
					...
					<ul class="nav nav-pills pople">
						...
						<li class="nav-item">
							<a class="nav-link" href="${pageContext.request.contextPath}/profile/portfoliolist_design.do">포트폴리오 </a>
						</li>
						<li class="nav-item">
							<a class="nav-link active" href="${pageContext.request.contextPath}/profile/knowhow_design.do">노하우 </a>
						</li>
						<li class="nav-item">
