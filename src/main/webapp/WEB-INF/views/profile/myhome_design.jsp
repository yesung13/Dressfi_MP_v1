        ...
        <div class="row mt-4">
            <div class="col-sm-12 col-md-12 col-xl-4 mb-4 mypage-fill pofill-bor">
                ...
                <table class="table table-borderless table-sm">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <span class="label-1 font-weight-bold">${ano1}</span> <span
                                class="label-1 font-weight-bold">${ano2}</span> <span
                                class="label-1 font-weight-bold">${ano3}</span>
                        </td>
            ...
            <div class="col-sm-12 col-md-12 col-xl-8  mypage-fill">
                ...
                <ul class="nav nav-pills pople">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                           href="${pageContext.request.contextPath}/profile/myportfoliolist.do">포트폴리오 </a>
                    </li>
                    <li class="nav-item">
                                ...
                                <div class="card-img-block">
                                    <a href="${pageContext.request.contextPath}/profile/pphotoview.do?ino=${item.ino}&userId=${userId}">
                                        <img class="img-fluid rounded border" src="${item.i_fileloc }"
                                             alt="${item.i_fileloc }" style="width:200px; height: 150px;"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-img-block">
                                    <a href="${pageContext.request.contextPath}/profile/knowhowview.do?hno=${item.hno}&userId=${userId}">
                                        <img class="img-fluid rounded border" src="${item.h_fileloc }"
                                             alt="${item.h_fileloc }" style="width:200px; height: 150px;"/>
                                    </a>
                                </div>
                            </div>
                        </div>
