		...
		<div class="container ">
			<div class="row mt-4">
				<div class="col-sm-12 col-md-12 col-xl-4 mb-4 mypage-fill pofill-bor">
					...
					<div class="d-flex justify-content-center mb-3 invisible">
						<!-- 									
						<button type="button" class="btn btn-link btn-info btn-width">
							<b>팔로우</b>
						</button> 
						
							
						<button type="button" class="btn btn-small bg-ddd">
							<i class="fas fa-ellipsis-h"></i>
						</button>  
						-->

						<button class="btn btn-secondary bg-ddd text-center text-black font-weight-bold w-100 mr-1">팔로우</button>
					...
					<table class="table table-borderless table-sm">
						...
						<tr>
							...
							<td colspan="2">
								<span class=""><a href="${profile.md_homepage }">${profile.md_homepage }</a></span>
							</td>
						</tr>
						<tr>
							<th>
						...
						<tr>
							...
							<td colspan="2">
								<span class="label-1 font-weight-bold">${ano1}</span> <span class="label-1 font-weight-bold">${ano2}</span> <span class="label-1 font-weight-bold">${ano3}</span>
							</td>
				...
				<div class="col-sm-12 col-md-12 col-xl-8  mypage-fill">
					...
					<ul class="nav nav-pills pople">
						...
						<li class="nav-item">
							<a class="nav-link" href="${pageContext.request.contextPath}/profile/myportfoliolist.do">포트폴리오 </a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="${pageContext.request.contextPath}/profile/myknowhow.do">노하우 </a>
					</ul>
					<!--포트폴리오 게시물 -->
