...
<body>
						...
						<li class="nav-logright">
							<ul class="nav navbar-right nav-log">
								...
								<li class="dropdown"><a
									...
									aria-expanded="false"> <span class="text-secondary mr-2">${userName}님${loginUser.name}</span>
	...
	<section>
		<div class="container mt-4">
			<div class="row">
				<div class="carousel_section col-12">
					<div id="carousel_section" class="carousel slide carousel-fade"
						data-ride="carousel">
						<ol class="carousel-indicators">
							<li data-target="#carousel_section" data-slide-to="0"
								class="active"></li>
							<li data-target="#carousel_section" data-slide-to="1"></li>
							<li data-target="#carousel_section" data-slide-to="2"></li>
						</ol>
						<div class="carousel-inner">
							<div class="carousel-item active" data-interval="3000">
								<img
									src="${pageContext.request.contextPath}/resources/images/ca01.PNG"
									class="d-block w-100 img-fluid border rounded" alt="...">

							</div>
							<div class="carousel-item" data-interval="3000">
								<img
									src="${pageContext.request.contextPath}/resources/images/ca2.jpg"
									class="d-block w-100 img-fluid border rounded" alt="...">

							</div>
							<div class="carousel-item" data-interval="3000">
								<img
									src="${pageContext.request.contextPath}/resources/images/ca05.jpg"
									class="d-block w-100 img-fluid border rounded" alt="...">
								<div class="carousel-caption d-none d-md-block">
									<p>
									<h3 class="text-info font-weight-bold">패션위크 정보 보러가기</h3>
									</p>
						...
						<a class="carousel-control-prev" href="#carousel_section"
							role="button" data-slide="prev"> <span
							class="carousel-control-prev-icon" aria-hidden="true"></span> <span
							class="sr-only">Previous</span>
						</a> <a class="carousel-control-next" href="#carousel_section"
	...
	<section>
		<div class="container">
			<div class="swiper-container">
				<h5 class="pt-5">
					<strong>오늘의 <b>BEST</b> 노하우
					</strong>
				</h5>
				<div class="swiper-wrapper">
					<c:forEach items="${klist}" var="item">
						<div class="swiper-slide">
							<div class="card profile-card-2">
								<div class="card-img-block">
									<a href=""> <img class="img-fluid border rounded"
										src="${item.h_fileloc }" alt="md04"
										style="width: 400px; height: 300px" />
									</a>
								</div>
								<div class="my-3">
									<div class="card-text">
										<span class="card-font font-weight-bold">${item.h_text }</span>
									</div>
									<p class="card-subtitle mt-1 mb-1 text-muted">
										<b>${item.h_name } </b>
									</p>
									<p class="card-subtitle text-muted">
										<small><b>조회수 &nbsp;7 &middot;</b><b> 좋아요
												&nbsp;${item.h_likecnt }</b></small>
									</p>
								</div>
							</div>
						</div>
									...
									<div class="card profile-card-2">
										<div class="card-img-block">
											<img class="img-fluid border rounded"
												src="${result.I_FILELOC}" alt="md1"
												style="width: 400px; height: 260px;'" />
										</div>
										<div class="card-body pt-5">
											<img
												src="${pageContext.request.contextPath}/resources/img/${result.MD_PROIMG}"
												alt="m1" class="profile" />
											<div class="card-title">
												<span> <strong>${result.MD_NAME }</strong>
												</span>
											</div>
										</div>
									</div>
							...
							<c:forEach items="${flist}" var="result">
								<div class="col-sm-6 col-md-6  col-xl-3">
									<div class="card profile-card-2">
										...
										<div class="card-body pt-5">
											<img
												src="${pageContext.request.contextPath}/resources/img/${result.MF_PROIMG}"
												alt="m1" class="profile" />
											<div class="card-title">
												<span> <strong>${result.MF_NAME }</strong>
												</span>
											</div>
										</div>
									</div>
							...
							<c:forEach items="${clist}" var="result">
								<div class="col-sm-6 col-md-6  col-xl-3">
									<div class="card profile-card-2">
										...
										<div class="card-body pt-5">
											<img
												src="${pageContext.request.contextPath}/resources/img/${result.MC_PROIMG}"
												alt="m1" class="profile" />
											<div class="card-title">
												<span> <strong>${result.MC_NAME }</strong>
												</span>
											</div>
										</div>
									</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="text-right">
					...
					<a class=""
						href="${pageContext.request.contextPath}/member/adminlogin.do">
