		...
		new daum.Postcode(
				{
					oncomplete : function(data) {
						...
						document.getElementById('mc_bzip').value = data.zonecode; //5자리 새우편번호 사용
						document.getElementById('mc_badd1').value = fullAddr;

						document.getElementById('mc_badd2').value = "";
						// 커서를 상세주소 필드로 이동한다.
						document.getElementById('mc_badd2').focus();
					}
				}).open();
	}
</script>
	...
	<section>
		<div class="container mt-1">
			...
			<ul class="nav nav-tabs flex-column flex-sm-row justify-content-center">
				...
				<li class="nav-item">
					<a class="flex-sm-fill text-sm-center nav-link active" href="joinPro3.do">도소매회원</a>
				</li>
			</ul>
			...
			<div class="container">
				<div class=" my-4 mx-4">
					<div class="">
						<h4 class="font-weight-bolder mt-2 mb-4">도소매회원</h4>
						<form action="/dressfi/member/joinPro3.do" onsubmit="return Check_Pass()" method="post" name="join" id="join" enctype="multipart/form-data">
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-75">
											<input type="text" class="form-control col-12" id="mc_userId" path="mc_userId" name="mc_userId" placeholder="이메일을 입력히세요" />
<!-- 											<div class="input-group-append">
								...
								<tr>
									...
									<td>
										<div class="input-group w-75">
											<input type="password" class="form-control text-truncate" path="mc_passwd" name="mc_passwd" id="mc_passwd" placeholder="6~16자의 영문, 숫자, 특수기호를 입력하세요" minlength="6" maxlength="16" />
										</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<input type="text" class="form-control" path="mc_name" id="mc_name" name="mc_name" maxlength="20" />
										</div>
									</td>
								</tr>
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-75">
											<input type="text" class="form-control" id="mc_phone" path="mc_phone" name="mc_phone" maxlength="11" />
										</div>
									</td>
								</tr>
								<tr>
									<th>
										<span class="">구분(도매,소매)</span><span class="font-weight-bold text-danger"><small>&nbsp;(필수)</small></span>
									</th>
									<td colspan="2">
										<div class="input-group w-50">
											<select class="custom-select" name="mc_div">
									...
									<th>
										<span class="">의류분야</span><span class="font-weight-bold text-danger"><small>&nbsp;(필수)</small></span>
									</th>
									<td colspan="2">
										<div class="input-group w-50">
											<select class="custom-select" name="mc_dept">
								...
								<tr>
									<th>
										<span class="">세부의류분야</span><span class="font-weight-bold text-danger"><small>&nbsp;(필수)</small></span>
									</th>
									<td colspan="2">
										<div class="input-group w-50">
											<select class="custom-select" name="mc_subdept">
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<select class="custom-select" path="mc_business" name="mc_business" id="mc_business">
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-75">
											<input type="text" class="form-control" path="mc_bnum" id="mc_bnum" name="mc_bnum" maxlength="10" placeholder="-없이  입력하세요" aria-describedby="button-addon2" />
										</div>
									</td>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<input type="text" class="form-control" path="mc_bname" id="mc_bname" name="mc_bname" placeholder="소속된 기관명 또는 상호명" />
										</div>
									</td>
								</tr>
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50 mb-1">
											<input type="text" class="form-control col-12" id='mc_bzip' path='mc_bzip' name='mc_bzip' size='7' maxlength='7' />
											<div class="input-group-append">
												<input type="button" class="btn btn-outline-secondary" onClick="DaumPostcode()" id="button-addon2" value="우편번호">
											</div>
										</div>
										<input type="text" class="form-control mb-1 w-75" maxlength='50' size='50' id='mc_badd1' name='mc_badd1' path='mc_badd1' />
										<input type="text" class="form-control w-75" maxlength='50' size='50' id='mc_badd2' name='mc_badd2' path='mc_badd2' />
									</td>
								</tr>
								<tr>
									<th>
									...
									<td colspan="2">
										<div class="form-inline">
											<select class="custom-select" path="mc_ano1" name="mc_ano1">
												<option value="10">서울</option>
												<option value="20">강원</option>
												<option value="30">대천</option>
											</select>
											<select class="custom-select mx-2" path="mc_ano2" name="mc_ano2">
												<option value="10">서울</option>
												<option value="20">강원</option>
												<option value="30">대천</option>
											</select>
											<select class="custom-select" path="mc_ano3" name="mc_ano3">
												<option value="10">서울</option>
												<option value="20">강원</option>
												<option value="30">대천</option>
											</select>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<input type="text" class="form-control" path="mc_homepage" name="mc_homepage" id="mc_homepage" placeholder="http://~" />
										</div>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-75">
											<textarea class="form-control" rows="5" path="mc_introduce" id="mc_introduce" name="mc_introduce"></textarea>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<input type="text" class="form-control" path="mc_kakaourl" id="mc_kakaourl" name="mc_kakaourl" placeholder="http://~" />
										</div>
									</td>
								</tr>
								<tr>
