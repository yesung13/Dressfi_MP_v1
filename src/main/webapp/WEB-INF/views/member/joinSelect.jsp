        ...
        <div class="row d-flex justify-content-center">
            <div class="d-flex justify-content-around">
                <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                    <!-- offset-lg-3 -->
                    <button class="btn btn-secondary btn-lg " style="width: 200px; height: 200px"
                            onclick="location.href='join.do'">
                        <img src="${pageContext.request.contextPath}/resources/images/member1.png"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <button class="btn btn-info btn-lg " style="width: 200px; height: 200px"
                            onclick="location.href='joinPro.do'">
                        <img src="${pageContext.request.contextPath}/resources/images/pro1.png"
                             class="mx-auto pl-4 d-block" alt="..">
                        <div class="mt-2">
                            <strong>전문가회원</strong>
                        </div>
                    </button>
