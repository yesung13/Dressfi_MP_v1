    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <form:form modelAttribute="userVO" action="/dressfi/member/join.do" onsubmit="return Check_Pass()"
                           method="post" name="join" id="join">
                    ...
                    <div class="form-group">
                        ...
                        <form:input type="text" class="form-control col-12" id="userId" path="userId" name="userId"
                    ...
                    <div class="form-group">
                        ...
                        <form:password class="form-control text-truncate" id="passwd" path="passwd" name="passwd"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="pass2" name="pass2" minlength="6"
                               maxlength="16"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <form:input type="text" class="form-control" id="phone" path="phone" name="phone" maxlength="11"
                                    placeholder="-없이 입력하세요"/>
                    </div>
                    <div class="form-group">
                        <label for="homepage">홈페이지</label>
                        <form:input type="text" class="form-control" id="homepage" path="homepage" name="homepage"
                                    placeholder="http://~"/>
                    </div>
                    <div class="form-group">
                        <label for="introduce">소개글</label>
                        <form:input type="text" class="form-control" id="introduce" path="introduce" name="introduce"
                                    maxlength="40" placeholder="40자이내 자신을 간단히 소개하세요"/>
                    </div>
                    <div class="form-group">
