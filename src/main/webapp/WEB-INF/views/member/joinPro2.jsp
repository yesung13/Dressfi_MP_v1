			...
			<div class="container">
				<div class=" my-4 mx-4">
					<div class="">
						...
						<form action="/dressfi/member/joinPro2.do" onsubmit="return Check_Pass()" method="post" name="join" id="join" enctype="multipart/form-data">
							<table class="table table-borderless">
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-75">
											<input type="text" class="form-control col-12" id="mf_userId" path="mf_userId" name="mf_userId" placeholder="이메일을 입력히세요" />
										</div>
									</td>
									<td></td>
									<!-- 공간맞춘것 지우지 말것 -->
								...
								<tr>
									...
									<td>
										<div class="input-group w-75">
											<input type="password" class="form-control text-truncate" path="mf_passwd" name="mf_passwd" id="mf_passwd" placeholder="6~16자의 영문, 숫자, 특수기호를 입력하세요" minlength="6" maxlength="16" />
										</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<input type="text" class="form-control" path="mf_name" id="mf_name" name="mf_name" maxlength="20" />
										</div>
									</td>
								</tr>
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-75">
											<input type="text" class="form-control" id="mf_phone" path="mf_phone" name="mf_phone" maxlength="11" />
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-75">
											<input type="text" class="form-control" path="mf_bnum" id="mf_bnum" name="mf_bnum" maxlength="10" placeholder="-없이  입력하세요" aria-describedby="button-addon2" />
										</div>
									</td>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<input type="text" class="form-control" path="mf_bname" id="mf_bname" name="mf_bname" placeholder="소속된 기관명 또는 상호명" />
										</div>
									</td>
								</tr>
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50 mb-1">
											<input type="text" class="form-control col-12" id='mf_bzip' path='mf_bzip' name='mf_bzip' size='7' maxlength='7' />
											<div class="input-group-append">
												<input type="button" class="btn btn-outline-secondary" onClick="DaumPostcode()" id="button-addon2" value="우편번호">
											</div>
										</div>
										<input type="text" class="form-control mb-1 w-75" maxlength='50' size='50' id='mf_badd1' name='mf_badd1' path='mf_badd1' />
										<input type="text" class="form-control w-75" maxlength='50' size='50' id='mf_badd2' name='mf_badd2' path='mf_badd2' />
									</td>
								</tr>
								<tr>
									<th>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<input type="text" class="form-control" path="mf_homepage" name="mf_homepage" id="mf_homepage" placeholder="http://~" />
										</div>
								...
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-75">
											<textarea class="form-control" rows="5" path="mf_introduce" id="mf_introduce" name="mf_introduce"></textarea>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td colspan="2">
										<div class="input-group w-50">
											<input type="text" class="form-control" path="mf_kakaourl" id="mf_kakaourl" name="mf_kakaourl" placeholder="http://~" />
										</div>
									</td>
								</tr>
								<tr>
