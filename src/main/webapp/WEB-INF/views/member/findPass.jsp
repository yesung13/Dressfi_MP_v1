    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <form:form modelAttribute="userVO" action="/dressfi/member/editPass.do" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" path="name" name="name" maxlength="10"
                               value="${member.name}"/>
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btn btn-secondary w-100" value="비밀번호 변경하러 가기"
                               onclick="retrun checkErrCode()"/>
