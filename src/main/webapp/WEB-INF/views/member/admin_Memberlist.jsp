...
<script type="text/javascript">
	function fnCmdDelete(sampleNo) {
		document.memberForm.mno.value = sampleNo;
		document.memberForm.action = "deletec.do";
	...
	<section>
		<div class="container mt-1">
			...
			<ul class="nav nav-tabs flex-column flex-sm-row">
				<li class="nav-item">
					<a class="flex-sm-fill text-sm-center nav-link active" href="/dressfi/member/adminlist.do">일반회원</a>
				</li>
				<li class="nav-item">
			...
			<div class="tab-content">
				...
				<div id="member" class="container">
					<h4 class="font-weight-bolder mt-4 mb-4">일반회원 리스트</h4>
					<form:form id="memberForm" name="memberForm" method="post" class="all_layout">
						<!--POST방식  -->
							...
							<tbody>
								<c:forEach var="result" items="${list}" varStatus="status">
									<tr align="center">
										...
										<td>${result.kakaourl}</td>
										<td>${result.joindate}</td>
										<td>
											<a href="#" onclick="fnCmdDelete('${result.mno}')" class="btn btn-info">삭제</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
