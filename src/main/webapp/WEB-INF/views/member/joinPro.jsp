        ...
        <div class="container">
            <div class=" my-4 mx-4">
                <div class="">
                    ...
                    <form modelAttribute="designVO" action="/dressfi/member/joinPro.do" onsubmit="return Check_Pass()"
                          method="post" name="join" id="join" enctype="multipart/form-data">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-75">
                                        <input type="text" class="form-control col-12" id="md_userId" path="md_userId"
                                               name="md_userId" placeholder="이메일을 입력히세요"/>
                                    </div>
                                </td>
                                <td></td>
                                <!-- 공간맞춘것 지우지 말것 -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group w-75">
                                        <input type="password" class="form-control text-truncate" path="md_passwd"
                                               name="md_passwd" id="md_passwd" placeholder="6~16자의 영문, 숫자, 특수기호를 입력하세요"
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50">
                                        <input type="text" class="form-control" path="md_name" id="md_name"
                                               name="md_name" maxlength="20"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-75">
                                        <input type="text" class="form-control" id="md_phone" path="md_phone"
                                               name="md_phone" maxlength="11"/>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-75">
                                        <input type="text" class="form-control" path="md_bnum" id="md_bnum"
                                               name="md_bnum" maxlength="10" placeholder="-없이  입력하세요"
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50">
                                        <input type="text" class="form-control" path="md_bname" id="md_bname"
                                               name="md_bname" placeholder="소속된 기관명 또는 상호명"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50 mb-1">
                                        <input type="text" class="form-control col-12" id='md_bzip' path='md_bzip'
                                               name='md_bzip' size='7' maxlength='7'/>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50">
                                        <input type="text" class="form-control" path="md_homepage" name="md_homepage"
                                               id="md_homepage" placeholder="http://~"/>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-75">
                                        <textarea class="form-control" rows="5" path="md_introduce" id="md_introduce"
                                                  name="md_introduce"></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="input-group w-50">
                                        <input type="text" class="form-control" path="md_kakaourl" id="md_kakaourl"
                                               name="md_kakaourl" placeholder="http://~"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
